...
class TestLoginCase(APITestCase):
    ...
    username = 'testfortest'
    email = 'test@fortest.ru'
    ...
    def _login(self):
        self.client.credentials(HTTP_USER_AGENT='Mozilla/5.0')
    ...
    def test_access_token_invalid_in_seven_day_after_logout(self):
        _, body = self._login()
        self.client.post(self.logout_url, body)
        m = mock.Mock()
